  ...
  return (
    <div className="landing-page">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-4 mb-lg-0">
              ...
              <p className="lead text-muted mb-4">
                Confused after Intermediate, B.Tech, or Graduation? CareerCompassAI helps
          ...
          <div className="row justify-content-center text-center">
            <div className="col-lg-9">
              ...
              <p className="lead text-muted">
                CareerCompassAI bridges the gap between academic education and industry expectations. 
      ...
      <section className="container my-5 py-4">
        <div className="text-center mb-5">
          <h2 className="fw-bold">Why Choose CareerCompassAI?</h2>
          <p className="text-muted lead">
      ...
      <footer className="bg-dark text-white py-4 mt-auto">
        <div className="container text-center">
          <div className="mb-2">
            <span className="fw-bold fs-5 text-primary">CareerCompassAI</span>
          </div>
          <p className="text-white-50 small mb-0">
            © {new Date().getFullYear()} CareerCompassAI. Empowering students with personalized AI career roadmaps.
          </p>
        </div>
      </footer>
    </div>
