  ...
  return (
    <div className="container mt-5 py-3">
      ...
      <div className="card shadow p-4 mb-5 border-0 rounded-4 bg-white">
        <h3 className="text-center text-primary fw-bold">🤖 CareerCompassAI Mentor</h3>
        <form onSubmit={handleAskAI}>
          <input
            ...
            required
          />
          <button type="submit" className="btn btn-primary w-100 mt-3 fw-bold rounded-pill" disabled={asking}>
            {asking ? "Thinking..." : "Ask AI Mentor"}
          </button>
        </form>

        {aiAnswer && (
          <div className="alert alert-success mt-4 rounded-3" style={{ whiteSpace: "pre-line" }}>
            {aiAnswer}
          </div>
        )}
      </div>
