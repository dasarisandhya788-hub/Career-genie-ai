...
import { EDUCATION_LEVELS, ACADEMIC_YEARS } from "../utils/constants.js";
...
export default function StudentDetails() {
  ...
  useEffect(() => {
    ...
    setEducation(userProfile?.education || localStorage.getItem("education") || "B.Tech");
    setCurrentYear(userProfile?.currentYear || localStorage.getItem("currentYear") || "3rd Year");
